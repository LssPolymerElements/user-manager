...
let LssUserManager = class LssUserManager extends PolymerElement {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            window.addEventListener('um-request-token', () => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    window.dispatchEvent(new CustomEvent('um-token', {
                        detail: {
                            jwtToken: token,
                            accessToken: this._getAccessTokenFromLocalStorage()
                        }
                    }));
                } catch (error) {
                    window.dispatchEvent(new CustomEvent('um-token', {
            ...
            window.addEventListener('um-request-person', () => __awaiter(this, void 0, void 0, function* () {
                if (!this._hasAuthenticated) {
                    try {
                        ...
                        window.dispatchEvent(new CustomEvent('um-person', {
                            detail: {
                                rejected: true,
                                message: error
                            }
    ...
    _handlePersonChange() {
        window.dispatchEvent(new CustomEvent('um-person-updated', {
            detail: {
                personId: this.personId,
                fullname: this.fullname,
                firstName: this.firstName,
            ...
            for (let i in hashArray) {
                if (hashArray.hasOwnProperty(i)) {
                    ...
                    if (keyValPair.length > 1) {
                        hashParams.push({
                            key: keyValPair[0],
                            value: decodeURIComponent(keyValPair[1])
                        });
                    }
                }
            }
    ...
    _setLocalProperties(jwtToken) {
        ...
        this.setProperties({
            personId: Number(jwtToken.nameid),
            fullname: jwtToken.unique_name,
        ...
        jwtRole.forEach(o => {
            if (this.roles.indexOf(o) === -1) {
                this.push('roles', o);
                window.dispatchEvent(new CustomEvent('um-role-added', {
                    detail: {
                        role: o
                    }
                }));
        ...
        this.roles.forEach((o, i) => {
            if (jwtRole.indexOf(o) === -1) {
                ...
                window.dispatchEvent(new CustomEvent('um-role-removed', {
                    detail: {
                        role: o
                    }
                }));
