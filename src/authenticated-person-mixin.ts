...
export interface AuthenticatedPersonMixinConstructor { new(...args: any[]): AuthenticatedPersonMixin; }
export interface AuthenticatedPersonMixin { _getPersonAsync(): Promise<any>; }
