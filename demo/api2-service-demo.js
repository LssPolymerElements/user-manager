...
let Api2ServiceDemo = class Api2ServiceDemo extends Polymer.DeclarativeEventListeners(Polymer.Element) {
    constructor() {
        super(...arguments);
        this.fruits = [];
        this.error = 'none';
    ...
    getFruits() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result;
            try {
                result = yield this.lssApiService.getAsync('Fruits/?$top=5&$orderby=Id desc', 'Testing');
            }
            catch (error) {
                this.error = error;
                return;
    ...
    createFruit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let fruit;
            try {
                fruit = yield this.lssApiService.postAsync('Fruits', dto);
            }
            catch (error) {
                this.error = error;
                return;
    ...
    deleteFruit(e) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (id > 0) {
                try {
                    yield this.lssApiService.deleteAsync(`Fruits(${id})`);
                }
                catch (error) {
                    this.error = error;
                    return;
    ...
    patchFruit(e) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (id > 0) {
                try {
                    yield this.lssApiService.patchAsync(`Fruits(${id})`, dto);
                }
                catch (error) {
                    this.error = error;
                    return;
    ...
    patchReturnDtoFruit(e) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (id > 0) {
                let returnFruit;
                try {
                    returnFruit = yield this.lssApiService.patchReturnDtoAsync(`Fruits(${id})`, dto);
                }
                catch (error) {
                    this.error = error;
                    return;
...
__decorate([
    Polymer.decorators.query('lss-api-service')
], Api2ServiceDemo.prototype, "lssApiService", void 0);
__decorate([
    Polymer
        .decorators.listen('tap', 'getButton')
], Api2ServiceDemo.prototype, "getFruits", null);
__decorate([
    Polymer
        .decorators.listen('tap', 'createButton')
